...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// calcularBtn
			// 
			this->calcularBtn->Location = System::Drawing::Point(104, 178);
			this->calcularBtn->Name = L"calcularBtn";
			this->calcularBtn->Size = System::Drawing::Size(75, 23);
			this->calcularBtn->TabIndex = 0;
			this->calcularBtn->Text = L"Calcular";
			this->calcularBtn->UseVisualStyleBackColor = true;
			this->calcularBtn->Click += gcnew System::EventHandler(this, &MyForm::button1_Click);
			// 
			// MyForm
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		int ejemplo[] = { 45, 23, 22, 12, 11 };
		vectorobj->Recorrido(ejemplo);
	}
	};
}
